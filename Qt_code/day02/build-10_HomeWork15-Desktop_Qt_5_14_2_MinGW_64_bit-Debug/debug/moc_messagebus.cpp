...
#include <memory>
#include "../../10_HomeWork15/messagebus.h"
...
QT_MOC_LITERAL(3, 28, 8), // "senderId"
QT_MOC_LITERAL(4, 37, 7), // "message"
QT_MOC_LITERAL(5, 45, 17) // "onMessageReceived"

    },
    "MessageBus\0messageReceived\0\0senderId\0"
    "message\0onMessageReceived"
};
...
void MessageBus::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MessageBus::messageReceived)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MessageBus::messageReceived(const QString & _t1, const QString & _t2)
{
