...
#include <memory>
#include "../../08_MoveToThread/mythread.h"
...
QT_MOC_LITERAL(1, 9, 10), // "signalQuit"
QT_MOC_LITERAL(2, 20, 0) // ""

    },
    "MyThread\0signalQuit\0"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyThread::signalQuit)) {
                *result = 0;
                return;
            }
        }
